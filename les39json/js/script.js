const color = {hex: '#7438f2', rgb: "244, 67, 54"}
...
const parseColor = JSON.parse(colorJSON)
...
const markupCard = colors.map(({hex, rgb}) => {
...
palette.addEventListener('click', e => {
    ...
    document.body.style.backgroundColor = swatch.dataset.hex
})